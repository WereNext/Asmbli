  ...
  return (
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container mx-auto max-w-4xl text-center">
          ...
          >
            <div className="max-w-5xl mx-auto px-2 sm:px-4">
              <motion.div
                className="rounded-lg sm:rounded-xl border bg-card p-1 sm:p-2 md:p-3 shadow-xl hover:shadow-2xl sm:shadow-2xl sm:hover:shadow-3xl transition-shadow duration-300"
          ...
          <motion.div
            ...
            animate="visible"
          >
            <motion.div className="text-center p-4 sm:p-0" variants={staggerItem}>
            ...
            <motion.div className="text-center p-4 sm:p-0 sm:col-span-2 lg:col-span-1" variants={staggerItem}>
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-warm-100 rounded-full flex items-center justify-center mx-auto mb-2 sm:mb-3">
          ...
          {/* Status Bar */}
          <motion.div
            className="mt-6 sm:mt-8 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 text-xs sm:text-sm text-muted-foreground px-4"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
      ...
      <section className="py-12 sm:py-16 lg:py-20 px-4">
        <div className="container mx-auto max-w-4xl text-center">
          <motion.h2
            className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6 font-display"
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, margin: "-100px" }}
            variants={fadeInUp}
